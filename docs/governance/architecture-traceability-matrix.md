...
| model-routing-table.md | `docs/architecture/model-routing-table.md` | Card 01 §4 (specialist-model routing principle), Card 06 §13/§23/§26 (classification-aware routing, binding rule), Card 07 §11 (provider metadata schema — table's adopted schema now exceeds this minimum, flagged for a Card 07 edit) | Stage 7 (2026-06) — drafted, reviewed twice, frozen at 1.0 |
